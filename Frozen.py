...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            case "1":
                products2.append("Frozen Dumplings")
            case "2":
                products2.append("Frozen Peas")
            case "3":
                products2.append("Frozen Carrots")
            case "4":
                products2.append("Frozen Pizza")
            case "5":
                products2.append("Frozen Fish")
            case "6":
                products2.append("Frozen Wings")
            case "7":
                products2.append("Frozen Chicken Breast")
            case "8":
                products2.append("Frozen Baby Carrots")
            case default:
...
def write(namefile,prices,item,lbs):
    ...
    for i in range(0,len(items)):
        match(items[i]):
            case "1":
                products.append("Frozen Dumplings")
            case "2":
                products.append("Frozen Peas")
            case "3":
                products.append("Frozen Carrots")
            case "4":
                products.append("Frozen Pizza")
            case "5":
                products.append("Frozen Fish")
            case "6":
                products.append("Frozen Wings")
            case "7":
                products.append("Frozen Chicken Breast")
            case "8":
                products.append("Frozen Baby carrots")
            case default:
                print("Theres a big problem")
                sys.exit()
