...
def Getitems(counter2):
    ...
    counter3 = 0
    whichone = str(input("Which item would you like to add to cart(Type a number 1-8): "))
    length = len(whichone)
...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            case "1":
                products2.append("Tomatoes")
            case "2":
                products2.append("Broccoli")
            case "3":
                products2.append("Lettuce")
            case "4":
                products2.append("Eggplant")
            case "5":
                products2.append("Carrot")
            case "6":
                products2.append("Yam")
            case "7":
                products2.append("Potato")
            case "8":
                products2.append("Kale")
            case default:
...
def write(namefile,prices,item,lbs):
    ...
    for i in range(0,len(items)):
        match(items[i]):
            case "1":
                products.append("Tomatoes")
            case "2":
                products.append("Broccoli")
            case "3":
                products.append("Lettuce")
            case "4":
                products.append("Eggplant")
            case "5":
