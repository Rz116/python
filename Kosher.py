...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            ...
            case "2":
                products2.append("Asparagus")
            case "3":
                products2.append("Milk")
            case "4":
