...
def getinfo():
    ...
    admin2 =  open("beveragePrice.txt","r")
...
def info2(counterthree):
    howmuch = str(input("How much of item " + temporary[counterthree ] + " would you like to buy: "))
    length = len(howmuch)
    check2 = list(howmuch)
    if(length < 1):
        print("Type in a correct input")
...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            case "1":
                products2.append("Beer")
            case "2":
                products2.append("Water")
            case "3":
                products2.append("Orange Juice")
            case "4":
                products2.append("Apple Juice")
            case "5":
                products2.append("Protein Milk")
            case "6":
                products2.append("Cows Milk")
            case "7":
                products2.append("Oat Milk")
            case "8":
                products2.append("Lemonade")
            case default:
...
def write(namefile,prices,item,lbs):
    ...
    for i in range(0,len(items)):
        match(items[i]):
            ...
            case "3":
                products.append("Orange Juice ")
            case "4":
                products.append("Apple Juice")
            case "5":
                products.append("Protein Milk")
            case "6":
                products.append("Cows Milk")
            case "7":
                products.append("Oat Milk")
            case "8":
                products.append("Lemonade")
            case default:
                print("Theres a big problem")
                sys.exit()
