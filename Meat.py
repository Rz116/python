...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            case "1":
                products2.append("Beef Steak")
            case "2":
                products2.append("Ground Beef")
            case "3":
                products2.append("Ground Pork")
            case "4":
                products2.append("Pork Chop")
            case "5":
                products2.append("Lamb Chop")
            case "6":
                products2.append("Bacon")
            case "7":
                products2.append("Pork Shoulder")
            case "8":
                products2.append("Lamb Leg")
            case default:
...
def write(namefile,prices,item,lbs):
    ...
    for i in range(0,len(items)):
        match(items[i]):
            case "1":
                products.append("Beef Steak")
            case "2":
                products.append("Ground Beef")
            case "3":
                products.append("Ground Pork")
            case "4":
                products.append("Pork chop")
            case "5":
                products.append("Lamb Chop")
            case "6":
                products.append("Bacon")
            case "7":
                products.append("Pork Shoulder")
            case "8":
                products.append("Lamb Leg")
            case default:
                print("Theres a big problem")
                sys.exit()
