...
def getinfo():
    ...
    admin2 =  open("poultryPrice.txt","r")
...
def exists(username,namefile):
    ...
    for i in range(len(items)):
        match(items[i]):
            case "1":
                products2.append("Chicken Thighs")
            case "2":
                products2.append("Duck")
            case "3":
                products2.append("Chicken wings")
            case "4":
                products2.append("Chicken Breast")
            case "5":
                products2.append("Roasted Chicken")
            case "6":
                products2.append("Turkey Leg")
            case "7":
                products2.append("Turkey Breast")
            case "8":
                products2.append("Chicken tender's")
            case default:
...
def write(namefile,prices,item,lbs):
    ...
    for i in range(0,len(items)):
        match(items[i]):
            case "1":
                products.append("Chicken thighs")
            case "2":
                products.append("Duck")
            case "3":
                products.append("Chicken Wings")
            case "4":
                products.append("Chicken Breast")
            case "5":
                products.append("Roasted Chicken")
            case "6":
                products.append("Turkey Leg")
            case "7":
                products.append("Turkey Breast")
            case "8":
                products.append("Chicken Tender's")
            case default:
                print("Theres a big problem")
                sys.exit()
